...
export function MaterialPanel({ material, setMaterial }: Props) {
  ...
  return (
    <div className="p-6 flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-zinc-400">Assign mechanical properties to the implant.</p>
      </div>
      ...
      <div className="grid gap-3">
        {materials.map((mat) => (
          ...
          >
            <div className="font-medium text-zinc-100 mb-3">{mat.label}</div>
